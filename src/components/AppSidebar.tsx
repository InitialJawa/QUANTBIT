        ...
        <div className="mx-2">
          ...
          <StrategySettingsPanel
            config={{
              ...
              crossoverMode: engineConfig.crossoverMode ?? "monthly",
        ...
        <div className="mx-2 mt-2">
          ...
          <StrategySettingsPanel
            config={{
              ...
              crossoverMode: backtestConfig.crossoverMode ?? "monthly",
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className={`w-5 h-5 rounded flex items-center justify-center transition-colors cursor-pointer ${
                    isWalletOpen ? "text-emerald-400 bg-emerald-500/10" : "text-white/30 hover:text-white/60 hover:bg-white/[0.06]"
                  }`}
                  title="Dompet"
                >
