    ...
    <div className="space-y-6">
      ...
      <div className="bg-[#050505] border border-white/[0.03] rounded-2xl p-5 shadow-sm">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <button
            ...
            className="px-4 py-2 bg-white/[0.02] border border-white/[0.05] hover:bg-white/[0.05] hover:border-white/20 text-white/80 text-label font-bold uppercase tracking-widest rounded-xl transition-all cursor-pointer flex items-center gap-2 disabled:opacity-50"
          >
        ...
        {syncStatus !== "idle" && (
          <motion.div
            ...
            className={`mt-6 p-4 rounded-xl border text-caption leading-relaxed flex items-start gap-3 font-mono uppercase tracking-widest ${
          ...
          >
            ...
            <div>
              <span className="font-black block text-caption mb-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-[#050505] border border-white/[0.03] p-5 rounded-2xl flex items-start gap-4">
          ...
          <div>
            <span className="text-label text-zinc-500 uppercase font-bold tracking-widest block font-mono">Integrity Validation</span>
            <span className="text-xs text-white/90 font-bold block mt-1 font-mono uppercase tracking-widest">PASSED (100% SECURE)</span>
            <p className="text-caption text-zinc-500 mt-2 leading-relaxed">All 30 corporate assets balance sheet ratios reconciled via double audit guidelines.</p>
          </div>
        </div>
        ...
        <div className="bg-[#050505] border border-white/[0.03] p-5 rounded-2xl flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-caption text-zinc-500 mt-2 leading-relaxed">Config F (Fundamental) and Config B (Backtest) coefficients fully loaded.</p>
          </div>
        </div>
        ...
        <div className="bg-[#050505] border border-white/[0.03] p-5 rounded-2xl flex items-start gap-4">
          ...
          <div>
            <span className="text-label text-zinc-500 uppercase font-bold tracking-widest block font-mono">Security Pipeline</span>
            <span className="text-xs text-white/90 font-bold block mt-1 font-mono uppercase tracking-widest">ACTIVE (LIVE JCI)</span>
            <p className="text-caption text-zinc-500 mt-2 leading-relaxed">Trailing stop alarms, MA support rails, and momentum indicators calculating smoothly.</p>
          </div>
        </div>
      ...
      <div className="space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mt-8 px-1">
          <h3 className="text-caption uppercase font-bold tracking-widest text-zinc-500 flex items-center gap-2 font-mono">
