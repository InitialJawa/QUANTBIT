...
- `fetch_idx80_scan.py` — fetch live Yahoo Finance data untuk semua IDX80 tickers, update idx80_scan.json. Scores dibaca dari local SQLite stock_fundamentals (norm_scores hasil komputasi fetch_historical_data.ts), fallback ke price-based computation.
